...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-5">Edit Daftar Buah</h1>

        <!-- Tombol Tambah Menu -->
        <div class="text-end mb-3">
            <a href="{{ route('tambah_buah') }}" class="btn btn-success">Tambah Menu</a>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $buah->harga }}</td>
                    <td>
                        <form action="{{ route('hapus_buah', $buah->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus buah ini?')"><i class="bi bi-trash">Hapus</i></button>
                        </form>
